...
def create_choreography(chat_history: Optional[List[ChatMessage]] = None):
    ...
    reviewer = FunctionCallingAgent(
        ...
        If the post is good, you can say 'The post is good.'""",
    ...
    return AgentCallingAgent(
        ...
        system_prompt="""You are an expert in writing blog posts. You are given a task to write a blog post. 
        Before starting to write the post, consult the researcher agent to get the information you need. 
