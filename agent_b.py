...
class AgentB:
    ...
    def ask_about_papers(self, paper_name: str, question: str) -> str:
        ...
        if not os.path.exists(filepath):
            return f"Could not locate the paper named {paper_name}. Here is a list of available papers: {os.listdir('./storage')}. You might find the paper you are looking for in the list above."
